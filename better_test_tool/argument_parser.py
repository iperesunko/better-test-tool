...
nosetests_command.add_argument('--copy', '-cp', action='store_true', help='copy result to clipboard')
...
pytest_comand.add_argument('--copy', '-cp', action='store_true', help='copy result to clipboard')
